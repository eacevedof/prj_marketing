 ...
 * @link eduardoaf.com
 * @name App\Restrict\BusinessData\Infrastructure\Controllers\BusinessDataInsertController
 * @file BusinessDataInsertController.php v1.0.0
...
use App\Restrict\BusinessData\Application\BusinessDataInsertService;
...
final class BusinessDataInsertController extends RestrictController
{
    ...
    public function create(): void
    {
        ...
        $this->set_template("insert")
            ...
            ->add_var(PageType::H1, __("New business_data"))
            ->add_var("business_datas", $this->picklist->get_business_data_types())
    ...
    public function insert(): void
    {
        ...
        try {
            $insert = SF::get_callable(BusinessDataInsertService::class, $this->request->get_post());
            $result = $insert();
            $this->_get_json()->set_payload([
                "message" => __("{0} successfully created", __("Business data")),
                "result" => $result,
            ])->show();
        }
