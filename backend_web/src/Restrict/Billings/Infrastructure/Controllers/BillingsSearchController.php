...
final class BillingsSearchController extends RestrictController
{
    public function index(?string $page = null): void
    {
        ...
        try {
            $search = SF::getInstanceOf(BillingsSearchService::class);

            $this->addGlobalVar(PageType::TITLE, __("Billings"))
                ->addGlobalVar(PageType::H1, __("Billings"))
    ...
    public function search(): void
    {
        ...
        try {
            $search = SF::getCallableService(BillingsSearchService::class, $this->requestComponent->getGet());
            $result = $search();
