 ...
 * @link eduardoaf.com
 * @name App\Repositories\XxxRepository 
...
final class XxxRepository extends AppRepository
{
    ...
    public function get_owner(string $xxxid): array
    {
        /**
         * @var HierarchyComponent $hier
         */
        $hier = CF::get("Hierarchy\Hierarchy");
        return $hier->get_topparent($xxxid, $this->get_all_hierarchy());
    }

    public function get_ownerid(string $xxxid): int
    {
        $owner = $this->get_owner($xxxid);
        return (int) $owner["id"];
    }

    public function get_childs(string $xxxid): array
    {
        /**
         * @var HierarchyComponent $hier
         */
        $hier = CF::get("Hierarchy\Hierarchy");
        return $hier->get_childs($xxxid, $this->get_all_hierarchy());
    }
