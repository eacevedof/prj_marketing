...
final class PrivacyPolicyInfoService extends AppService
{
    public function __invoke(): array
    {
        $r = [
            ...
            ["p" => __("Your data will be kept as long as the contractual relationship between the Organization and ProviderXXX Spain for the use of the Meikai platform is maintained, or as long as the Organization does not request ProviderXXX Spain to modify or delete the data provided in the form. However, the data may be kept blocked during the legally applicable prescription periods.")],
