...
final class PrivacyPolicyInfoService extends AppService
{
    public function __invoke(): array
    {
        $r = [
            ...
            ["p" => __("The legal basis of the treatments with the purposes described is the legitimate interest in the treatment of said data, being necessary for the formalization and maintenance of the contractual relationship between My Promos and the contracting Organization")],

            ["h3" => __("Who are the recipients of your data?")],
            ["p" => __("Your data may be communicated to the My Promos's Organizations, some of which are located in countries outside the European Economic Area that have not been declared by the European Commission to have an adequate level of data protection.")],
