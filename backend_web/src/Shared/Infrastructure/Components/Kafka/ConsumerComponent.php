 ...
 * @link eduardoaf.com
 * @name App\Shared\Infrastructure\Components\Kafka\ConsumerComponent
...
use RdKafka\{Conf, Consumer, ConsumerTopic, TopicConf};
        ...
        while (true) {
            ...
            switch ($messages->err) {
                case RD_KAFKA_RESP_ERR_NO_ERROR:
                    ...
                    if(is_callable($fn_onresponse) && $messages) {
                        call_user_func_array($fn_onresponse, [$messages]);
                    }
