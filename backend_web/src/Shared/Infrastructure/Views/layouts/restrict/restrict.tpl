...
?>
  ...
  <div class="main-footer ht-40">
    <div class="container-fluid pd-t-0-f ht-100p">
      <span>Copyright © 2021 <a href="https://twitter.com/eacevedof" target="_blank">Eduardo A. F.</a>. Designed by <a href="https://test.eduardoaf.com" target="_blank">eduardoaf.com</a> All rights reserved.</span>
    </div>
  </div>
