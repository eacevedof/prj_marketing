...
return [
    [
        "url" => "/afiliado/:businessSlug/promocion/:promotionSlug",
    ...
    [
        "url" => "/partner/:businessSlug/promotionscap/:promotionUuid/insert",
    ...
    [
        "url" => "/afiliado/:businessSlug/puntos-usuario/:capuseruuid",
    ...
    ["url" => "/error/forbidden-403","controller" => "App\Open\Errors\Infrastructure\Controllers\ErrorsController","method" => "forbidden403", "name" => ""],
    ["url" => "/error/unexpected-500","controller" => "App\Open\Errors\Infrastructure\Controllers\ErrorsController","method" => "internal500", "name" => ""],
    //la 404 debe ser la última ruta siempre
    ["url" => "/error/not-found-404","controller" => "App\Open\Errors\Infrastructure\Controllers\ErrorsController","method" => "notFound404", "name" => ""],
];
