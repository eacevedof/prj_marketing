...
const URL_UPDATE = "/restrict/user_permissionss/update"
const ACTION = "user_permissionss.update"
...
if (!customElements.get("form-user_permissions-update"))
  customElements.define("form-user_permissions-update", FormUserPermissionsUpdate)
