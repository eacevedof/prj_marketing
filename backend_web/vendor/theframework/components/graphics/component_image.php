...
class ComponentImage
{
    ...
    public function make_thumb()
    {
        ...
        if ($iSrcWidth > $this->iWidth || $iSrcHeight > $this->iHeight) {
            ...
            if ($fPerHeight > $fPerWidth) {
                $fPerAdjust = $fPerHeight;
            }
        ...
        if ($oImageCut) {
            ...
            if (!$isCreated) {
                $this->add_error("Error: Thumb not created");
            }
        } else {
    ...
    {
        $this->sFilenameSource = $sFileName;
        $this->load_source_extension();
    }
    public function set_filename_target($sFileName)
    {
        $this->sFilenameTarget = $sFileName;
        $this->load_target_extension();
    }
    public function set_path_folder_source($sPathFolder)
    {
        $this->sPathFolderSource = $sPathFolder;
    }
    public function set_path_folder_target($sPathFolder)
    {
        $this->sPathFolderTarget = $sPathFolder;
    }
    public function set_target_content($sContent)
    {
        $this->sTargetContent = $sContent;
    }

    public function set_pathsource_http($value)
    {
        $this->sPathsourceHttp = $value;
    }
    public function set_meta_filename($value)
    {
        $this->sMetaFilename = $value;
    }
    public function set_meta_filedatetime($value)
    {
        $this->sMetaFileDatetime = $value;
    }
    public function set_meta_filesize($value)
    {
        $this->sMetaFilesize = $value;
    }
    public function set_meta_filetype($value)
    {
        $this->sMetaFiletype = $value;
    }
    public function set_meta_mimetype($value)
    {
        $this->sMetaMimetype = $value;
    }
    public function set_meta_sections($value)
    {
        $this->sMetaSections = $value;
    }
    public function set_meta_html($value)
    {
        $this->sMetaHtml = $value;
    }
    public function set_meta_height($value)
    {
        $this->iMetaHeight = $value;
    }
    public function set_meta_width($value)
    {
        $this->iMetaWidth = $value;
    }
    public function set_is_meta_color($value)
    {
        $this->isMetaColor = $value;
    }
    public function set_meta_content($value)
    {
        $this->sMetaComment = $value;
    }
    ...
    public function get_pathsource_http()
    {
        return $this->sPathsourceHttp;
    }
    public function get_meta_filename()
    {
        return $this->sMetaFilename;
    }
    public function get_meta_filedatetime()
    {
        return $this->sMetaFileDatetime;
    }
    public function get_meta_filesize()
    {
        return $this->sMetaFilesize;
    }
    public function get_meta_filetype()
    {
        return $this->sMetaFiletype;
    }
    public function get_meta_mimetype()
    {
        return $this->sMetaMimetype;
    }
    public function get_meta_sections()
    {
        return $this->sMetaSections;
    }
    public function get_meta_html()
    {
        return $this->sMetaHtml;
    }
    public function get_meta_height()
    {
        return $this->iMetaHeight;
    }
    public function get_meta_width()
    {
        return $this->iMetaWidth;
    }
    public function get_is_meta_color()
    {
        return $this->isMetaColor;
    }
    public function get_meta_content()
    {
        return $this->sMetaComment;
    }
    public function get_bytes_size()
    {
        return $this->iBitsSize;
    }

    public function get_source_extension()
    {
        return $this->sExtensionSource;
    }
    public function get_target_extension()
    {
        return $this->sExtensionTarget;
    }
