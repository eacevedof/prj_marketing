...
class ComponentDbSqlite
{
    ...
    public function __construct($sPathFolder = "", $sDbName = "app.sqlite3")
    {
        ...
        if (!$this->sPathFolder) {
            $this->sPathFolder = TFW_PATH_APPLICATIONDS."appdb";
        }
        if (!$this->sDbName) {
            $this->sDbName = "app.sqlite3";
        }
    ...
    public function is_persistent($isOn = true)
    {
        $this->isPersistent = $isOn;
    }
    public function set_folder($sValue)
    {
        $this->sPathFolder = $sValue;
    }
    public function set_dbname($sValue)
    {
        $this->sDbName = $sValue;
    }
    public function get_errors()
    {
        return isset($this->arMessages["error"]) ? $this->arMessages["error"] : [];
    }
    private function is_noterror()
    {
        return !$this->isError;
    }
    ...
    {
        return isset($this->arMessages["debug"]) ? $this->arMessages["debug"] : [];
    }
