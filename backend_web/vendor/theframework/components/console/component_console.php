...
class ComponentConsole
{
    ...
    public function set_pathclass($sPath)
    {
        $this->sPathClass = $sPath;
    }
    public function set_classname($sClassName)
    {
        $this->sClassName = $sClassName;
    }
    public function set_method($sMethod)
    {
