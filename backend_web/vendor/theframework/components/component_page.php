...
class ComponentPage
{
    ...
    */
    ...
    {
        return $this->get_array_page_items();
    }

    /**
    * Devuelve un array tipo arBotones[anterior], arBotones[siguiente] ...
    */
    public function get_buttons_to_show()
    {
        return $this->get_navigation_array();
    }
    ...
    */
    ...
    {
        return $this->iNumOfPages;
    }
    public function get_total_regs()
    {
        return $this->iNumTotalItems;
    }
    public function get_current()
    {
        return $this->iNumRequestPage;
    }
    public function get_next()
    {
        return $this->iNumNextPage;
    }
    public function get_previous()
    {
        return $this->iNumPreviousPage;
    }
    public function get_first()
    {
        return $this->iNumFirstPage;
    }
    public function get_last()
    {
        return $this->iNumLastPage;
    }
    public function get_items_per_page()
    {
        return $this->iNumItemsPerPage;
    }
    ...
    public function set_request_page($iNumPage)
    {
        $this->iNumRequestPage = $this->avoid_not_number($iNumPage);
    }
    public function set_url_pattern($value)
    {
        $this->sUriPagePattern = $value;
    }
    public function set_items($arItems)
    {
        $this->arItems = $arItems;
        $this->iNumTotalItems = count($arItems);
    }
