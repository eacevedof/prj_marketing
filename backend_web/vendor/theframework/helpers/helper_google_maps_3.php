...
class HelperGoogleMaps3
{
    ...
    {
        //bug($this); die;
        if($this->_useGoogleJquery) {
            $this->show_google_jquery_tag();
        }
...
<?php
    ...
    public function get_distance_and_time(array $arPoint1, array $arPoint2)
    {
        ...
        if(!empty($this->_sClientId)) {
            $arParams["clientid"] = "client=$this->_sClientId";
        }
        if(!empty($this->_sChannel)) {
            $arParams["channel"] = "channel=$this->_sChannel";
        }
    ...
    public function show_google_jquery_tag()
    {
        echo $this->get_google_jquery();
    }

    public function show_apikey_tag()
    {
        echo $this->get_apikey_tag();
    }
    ...
    {
        return $this->_arMarkers;
    }
    public function is_makers_with_numbers()
    {
        if($this->_useMakersNumbers) {
            echo "true";
        } else {
            echo "false";
        }
    ...
    private function do_draw_routes()
    {
        if($this->_drawRoutes) {
            echo "true";
        } else {
                ...
                if(strcmp($oXmlStatus, "OK") == 0) {
                    ...
                    if($this->_doNarrowSearch) {
                        if($this->is_in_range_latlong($fLatitude, $fLongitude)) {
                            $arLl["latitude"] = $fLatitude;
                            $arLl["longitude"] = $fLongitude;
    ...
    public function get_jsapi_v3_tag()
    {
        ...
        if(!empty($this->_sClientId)) {
            $sUrlJsApi .= "&client=$this->_sClientId";
        }
        if(!empty($this->_sChannel)) {
            $sUrlJsApi .= "&channel=$this->_sChannel";
        }
    ...
    private function get_maptype()
    {
        echo $this->_sMapType;
    }
    private function get_div_container()
    {
        echo $this->_sIdDivContainer;
    }
    private function get_zoom()
    {
        echo $this->_iZoom;
    }
    private function get_latitude()
    {
        echo $this->_fLatitude;
    }
    private function get_longitude()
    {
        echo $this->_fLongitude;
    }
    ...
    {
        echo "'$this->_sRouteMode'";
    }
    private function get_route_color()
    {
        echo "'$this->_sRouteColor'";
    }
    private function get_route_width()
    {
        echo $this->_iRouteWidth;
    }
    private function get_route_alpha()
    {
        echo $this->_fRouteAlpha;
    }
    private function get_marker_color()
    {
        echo "'$this->_sMarkerColor'";
    }
    ...
    public function set_markers($arMarkers = array())
    {
        $this->_arMarkers = $arMarkers;
    }
    public function set_markers_numbers_off($isOn = false)
    {
        $this->_useMakersNumbers = $isOn;
    }

    public function set_maptype($sValue)
    {
        $this->_sMapType = strtolower("'$sValue'");
    }
    public function set_div_container($sValue)
    {
        $this->_sIdDivContainer = "'$sValue'";
    }
    public function set_zoom($iZoom)
    {
        $this->_iZoom = $iZoom;
    }
    public function set_latitude($fLatitude)
    {
        $this->_fLatitude = $fLatitude;
    }
    public function set_longitude($fLongitude)
    {
        $this->_fLongitude = $fLongitude;
    }
    public function draw_lines($isOn = true)
    {
        $this->_drawLines = $isOn;
    }
    ...
    public function set_size_unit($sType = "pt")
    {
        $this->_sUnitWH = $sType;
    }
    public function add_address(array $arAddress)
    {
        $this->_arAddresses[] = $arAddress;
    }
    public function draw_routes($isOn = true)
    {
        $this->_drawRoutes = $isOn;
    }
    public function set_route_color($sColor = "green")
    {
        $this->_sRouteColor = $sColor;
    }
    public function set_marker_color($sColor = "green")
    {
        $this->_sMarkerColor = $sColor;
    }

    /**
     * @param string $sType driving, walking, bicycling
     */
    public function set_route_type($sType = "driving")
    {
        $this->_sRouteMode = $sType;
    }

    public function set_route_width($iWidth = 3)
    {
        $this->_iRouteWidth = $iWidth;
    }
    public function set_route_alpha($fAlpha = 0.5)
    {
        $this->_fRouteAlpha = $fAlpha;
    }
     ...
     * @param boolean $isOn
     */
    public function no_narrow($isOn = false)
    {
        $this->_doNarrowSearch = $isOn;
    }
    public function set_delay_time($iMicroSeconds)
    {
        $this->_iDelayTime = $iMicroSeconds;
    }
    public function no_dalay($isOn = false)
    {
        $this->_useDelay = $isOn;
    }
    public function set_apikey($sApikey)
    {
        $this->_sApikey = $sApikey;
    }
    public function no_auto_apikey($isOn = false)
    {
        $this->_useApikey = $isOn;
    }
    public function no_google_jquery($isOn = false)
    {
        $this->_useGoogleJquery = $isOn;
    }
    public function set_signature($sValue)
    {
        $this->_sSignature = $sValue;
    }
    public function use_signature($isOn = true)
    {
        $this->_useSignature = $isOn;
    }
    public function set_cryptokey($sValue)
    {
        $this->_sCriptokey = $sValue;
    }
    public function use_cryptokey($isOn = true)
    {
        $this->_useCriptoKey = $isOn;
    }
    public function set_client_id($sId)
    {
        $this->_sClientId = $sId;
    }
    public function set_channel($sChannelJs)
    {
        $this->_sChannel = $sChannelJs;
    }
}
