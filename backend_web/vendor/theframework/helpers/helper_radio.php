...
class HelperRadio extends TheFrameworkHelper
{
    ...
    public function get_html()
    {
        ...
        if($this->_legendtext) {
            $sHtmlToReturn .= "<legend>$this->_legendtext</legend>\n";
        }
    ...
    private function build_input_radio($id, $value, HelperLabel $oLabel = null, $isChecked = false)
    {
        ...
        if($value) {
            $sHtmlToReturn .= " value=\"$value\"";
        }
        if($isChecked) {
            $sHtmlToReturn .= " checked" ;
        }
        //propiedades html5
    ...
    public function set_value_to_check($value)
    {
        $this->_value_to_check = $value;
    }
    public function set_legendtext($value)
    {
    ...
    public function get_value_checked()
    {
        return $this->_value_to_check;
    }
    public function get_legendtext()
    {
