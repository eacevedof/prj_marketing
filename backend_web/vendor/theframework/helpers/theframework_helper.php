...
class TheFrameworkHelper
{
     ...
     */
    protected function load_cssclass()
    {
        if($this->arClasses) {
            $this->_class = trim(implode(" ", $this->arClasses));
        }
    }
    /**
    ...
    */
    ...
    {
        if($this->arStyles) {
            $this->_style = trim(implode(";", $this->arStyles));
        }
    }
    /**
    ...
    public function set_idprefix($value)
    {
    ...
    public function set_js_onclick($value)
    {
        $this->_js_onclick = $value;
    }
    public function set_js_onchange($value)
    {
        $this->_js_onchange = $value;
    }
    public function set_js_keypress($value)
    {
        $this->_js_onkeypress = $value;
    }
    public function set_js_keydown($value)
    {
        $this->_js_onkeydown = $value;
    }
    public function set_js_keyup($value)
    {
        $this->_js_onkeyup = $value;
    }
    public function set_js_onblur($value)
    {
        $this->_js_onblur = $value;
    }
    public function set_js_onfocus($value)
    {
        $this->_js_onfocus = $value;
    }
    public function set_js_onmouseover($value)
    {
        $this->_js_onmouseover = $value;
    }
    public function set_js_onmouseout($value)
    {
        $this->_js_onmouseout = $value;
    }
    ...
    protected function required($isRequired = true)
    {
        $this->_isRequired = $isRequired;
    }
    protected function readonly($isReadOnly = true)
    {
        $this->_isReadOnly = $isReadOnly;
    }
    protected function disabled($isDisabled = true)
    {
     ...
     */
    public function add_inner_object($mxValue)
    {
        if($mxValue) {
            $this->arInnerObjects[] = $mxValue;
        }
    }

    public function set_extras(array $value)
    {
        $this->arExtras = array();
        if($value) {
            $this->arExtras = $value;
    ...
    protected function set_placeholder($value)
    {
        $this->_placeholder = htmlentities($value);
    }
    public function set_attr_dbtype($value)
    {
        $this->_attr_dbtype = $value;
    }
    public function set_attr_dbfield($value)
    {
        $this->_attr_dbfield = $value;
    }
    public function set_as_primarykey($isPk = true)
    {
        $this->_is_primarykey = $isPk;
    }
    public function set_innerhtml($sInnerHtml, $asEntity = 0)
    {
        if($asEntity) {
            $this->_inner_html = htmlentities($sInnerHtml);
        } else {
    ...
    public function set_postback($isOn = true)
    {
        $this->_isPostback = $isOn;
    }
    public function on_enterinsert($isOn = true)
    {
        $this->_isEnterInsert = $isOn;
    }
    public function on_enterupdate($isOn = true)
    {
        $this->_isEnterUpdate = $isOn;
    }
    public function on_entersubmit($isOn = true)
    {
        $this->_isEnterSubmit = $isOn;
    }
    ...
    protected function set_label(HelperLabel $oLabel)
    {
        $this->oLabel = $oLabel;
    }
    public function set_class($class)
    {
        $this->arClasses = array();
        if($class) {
            $this->arClasses[] = $class;
        }
    }
    ...
    protected function set_style_object(HelperStyle $oStyle)
    {
        $this->oStyle = $oStyle;
    }
    ...
    protected function reset_style()
    {
        $this->arStyles = array();
        $this->_style = "";
    }
    protected function reset_inner_object()
    {
        $this->arInnerObjects = array();
    }
    protected function set_inner_objects($arObjHelpers)
    {
        $this->arInnerObjects = $arObjHelpers;
    }
    protected function set_value($value, $asEntity = 0)
    {
        ($asEntity) ? $this->_value = htmlentities($value) : $this->_value = $value;
    }
    ...
    {
        return $this->_attr_dbtype;
    }
    public function is_primarykey()
    {
    ...
    //to override
    protected function show_opentag()
    {
        echo $this->get_opentag();
    }
    //to override
    protected function show_closetag()
    {
        echo $this->get_closetag();
    }
    protected function get_label()
    {
        return $this->oHlpLabel;
    }
    protected function get_style()
    {
        return $this->oHlpStyle;
    }
    ...
    protected function is_enterinsert()
    {
        return $this->_isEnterInsert;
    }
    protected function is_enterupdate()
    {
        return $this->_isEnterUpdate;
    }
    protected function is_entersubmit()
    {
        return $this->_isEnterSubmit;
    }
    protected function get_value($asEntity = 0)
    {
        if($asEntity) {
