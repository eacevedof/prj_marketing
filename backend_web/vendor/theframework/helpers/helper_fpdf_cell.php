...
class HelperFpdfCell extends TheFrameworkHelper
{
    ...
    public function set_single($isOn = true)
    {
        $this->isSingle = $isOn;
    }
    public function set_width($iValue)
    {
        $this->iWidth = $iValue;
    }
    public function set_height($iValue)
    {
        $this->iHeigth = $iValue;
    }
    public function set_text($sValue)
    {
        $this->sText = $sValue;
    }
    public function set_border($iWidth)
    {
        $this->iBorder = $iWidth;
    }
    public function set_numline_unit($iUnit)
    {
        $this->iNumNL = $iUnit;
    }
    /**
     ...
     */
    public function set_type_align($cAlign)
    {
        $this->cAlign = $cAlign;
    }
    public function set_usefill($isOn = true)
    {
        $this->isFill = $isOn;
    }
    public function set_pagelink($sValue)
    {
        $this->sUrlPageLink = $sValue;
    }

    public function set_x($iX)
    {
        $this->iX = $iX;
    }
    public function set_y($iY)
    {
        $this->iY = $iY;
    }

    public function set_font($sValue)
    {
        $this->sFont = $sValue;
    }
    /**
     ...
     */
    public function set_fontstyle($sValue)
    {
        $this->sFontStyle = $sValue;
    }
    public function set_fontsize($iSize)
    {
        $this->iFontSize = $iSize;
    }
    public function set_fontcolor($iValue)
    {
        $this->iFontColor = $iValue;
    }
    public function set_backcolor($iValue)
    {
        $this->iBackColor = $iValue;
    }
    public function set_resetcolors($isOn = true)
    {
    ...
    public function get_numline_unit()
    {
        return $this->iNumNL;
    }
    public function get_type_align()
    {
        return $this->cAlign;
    }
    public function get_usefill()
    {
        return $this->isFill;
    }
    public function get_pagelink()
    {
        return $this->sUrlPageLink;
    }
    ...
    public function is_resetcolors()
    {
