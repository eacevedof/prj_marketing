...
class HelperSelect extends TheFrameworkHelper
{
    ...
    public function __construct($arOptions, $id = "", $name = "", HelperLabel $oLabel = null, $mxValueToSelect = "", $size = 1, $isMultiple = false, $arExtras = "", $class = "", $isReadOnly = false)
    {
        $this->_type = "select";
    ...
    public function get_opentag()
    {
        ...
        if($this->_size) {
            $sHtmlToReturn .= " size=\"$this->_size\"";
        }
        if($this->_isMultiple) {
            $sHtmlToReturn .= " multiple";
        }
        if($this->_isDisabled) {
    ...
    public function set_value_to_select($mxValues)
    {
        $this->mxValuesToSelect = $mxValues;
    }
    public function set_null_option_text($value)
    {
        $this->_null_option = $value;
    }
    ...
    public function set_options($arOptions)
    {
        $this->arOptions = $arOptions;
    }
    ...
    {
        return $this->mxValuesToSelect;
    }
    public function get_closetag()
    {
        return parent::get_closetag();
    }
}
