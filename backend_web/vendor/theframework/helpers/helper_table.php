...
class HelperTable extends TheFrameworkHelper
{
    ...
    public function __construct($arMxTrs = array(), $id = "", $class = "", $style = "", $arExtras = array())
    {
    ...
    public function get_html()
    {
        ...
        if(!$this->_inner_html) {
            $this->_inner_html = $this->get_html_rows();
        }
    ...
    //             SETS
    //**********************************
    public function use_header($isOn = true)
    {
        $this->useThead = $isOn;
    }
    public function use_footer($isOn = true)
    {
        $this->useTfoot = $isOn;
    }
     ...
     */
    public function add_objrow($mxValue)
    {
        $this->arObjTrs[] = $mxValue;
        $this->iNumRows = count($this->arObjTrs);
        $this->load_numcols();
    }

    public function add_tr(HelperTableTr $oTr)
    {
        $this->arObjTrs[] = $oTr;
        $this->iNumRows = count($this->arObjTrs);
        $this->load_numcols();
    ...
    //             GETS
    //**********************************
    public function get_objrows()
    {
        return $this->arObjTrs;
    }
