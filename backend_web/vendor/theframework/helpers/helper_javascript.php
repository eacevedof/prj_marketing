...
class HelperJavascript extends TheFrameworkHelper
{
    ...
    public function __construct($sSubPathExt = "", $arSubPathFiles = array())
    {
        ...
        if(defined("TFW_SUBPATH_JSDS")) {
            $this->sSubpathJs = TFW_SUBPATH_JSDS;
        }//@check
        if(defined("TFW_SUBPATH_PLUGINDS")) {
    ...
    public function add_multiform($sFormId, $sSaveAction = "insert")
    {
        $this->arMultiForm[] = ["formid" => $sFormId,"saveaction" => $sSaveAction];
    }
    ...
    {
        $this->add_filesrc($sFileName, $sType, $this->sSubpathJs);
    }
    //public function set_path_files($arPaths){$this->arPathfiles = $arPaths;}
    public function add_js_line($sScriptLine)
    {
        $this->arJsLines[] = $sScriptLine;
    }
    public function add_path_file($sFilePath)
    {
        $this->arPathfiles[] = $sFilePath;
    }
    ...
    public function set_validate_config($arValidate)
    {
        $this->arValidate = $arValidate;
    }
    public function set_updateaction($sAction = "update")
    {
        $this->sSaveAction = $sAction;
    }

    //**********************************
    //             GETS
    //**********************************
    public function get_opentag($attrib = "")
    {
        return "<script type=\"text/javascript\"$attrib>\n";
    }
...
<?php
    ...
    public function set_focusid($value)
    {
        $this->sFocusId = $value;
    }
    public function set_filters($arFields)
    {
        $this->arFilters = $arFields;
    }
    public function set_formid($value)
    {
        $this->sFormId = $value;
    }
    ...
    //           MAKE PUBLIC
    //**********************************
    public function show_opentag()
    {
        echo $this->get_opentag();
    }
    public function show_closetag()
    {
        echo $this->get_closetag();
    }
    public function show_fn_multiassign()
    {
        echo $this->fn_multiassign_window();
    }
    public function show_fn_singleassign_window()
    {
        echo $this->fn_singleassign_window();
    }
    public function show_fn_multiadd()
    {
        echo $this->fn_multiadd();
    }
    public function show_fn_singleadd()
    {
        echo $this->fn_singleadd();
    }
    public function show_fn_closeme()
    {
        echo $this->fn_closeme();
    }
    public function show_fn_resetfilters()
    {
        echo $this->fn_resetfilters();
    }
    public function show_fn_setfocus()
    {
        echo $this->process_focus();
    }
    public function show_fn_save()
    {
        echo $this->fn_save();
    }
    public function show_check_before_save($arValidate = array())
    {
        echo $this->check_before_save($arValidate);
    }
    public function show_fn_postback()
    {
        echo $this->fn_postback();
    }
    public function show_fn_parentform()
    {
        echo $this->fn_parentform();
    }
    public function show_fn_setvallike()
    {
        echo $this->fn_setvallike();
    }
    public function show_fn_enterinsert()
    {
        echo $this->fn_onenter_insert();
    }
    public function show_fn_enterupdate()
    {
        echo $this->fn_onenter_update();
    }
    public function show_fn_entersubmit()
    {
        echo $this->fn_onenter_submit();
    }
