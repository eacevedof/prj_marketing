...
final class CreateAppPromotionUsers extends AbsMigration
{
    private string $tablename = "app_promotion_users";
    ...
    private function _create_table(): void
    {
        ...
        ->addColumn("id_gender", "integer", [
            ...
            "null" => false,
            "default" => 1,
            "comment" => "app_array.type=gender, id_relation:0: female, 1: male, 2:neutral",
        ])
